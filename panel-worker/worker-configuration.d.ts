/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bb5a6eb36999fa4f3f62bb5fe4d9fc48)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	TZ_OFFSET_HOURS: "7";
	CRON_KEY: "2ivwrtzgczxuwe1w637k0l4ki9g4hthh2m64jnrz";
	PUBLIC_URL: "https://panel-worker.projectbykd.workers.dev";
	GH_REPO: "projectbykd-jpg/daygroup-scraper";
	LIVECHAT_BOT: DurableObjectNamespace<import("./src/index").LivechatBotDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LivechatBotDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TZ_OFFSET_HOURS" | "CRON_KEY" | "PUBLIC_URL" | "GH_REPO">> {}
}
